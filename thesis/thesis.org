...
#+BEGIN_SRC python :results output file :exports results
  ...
  y = 1 - np.exp(- (x + 0.1) * 4.02)

  ax.plot(x, y,
          linestyle='-',
          color='black')

  ax.plot([0.3, 0.3], [0.3, 0.8],
          linestyle='-',
          color='grey',
          zorder=-5)
  ...
  plt.tight_layout(pad=0, rect=(0.03, 0, 1, 1))
...
#+CAPTION: Utility function with threshold on $x_{lim}$, minimum value for $x$ to be acceptable.
#+ATTR_LATEX: :height 4in
#+LABEL: utility_example
#+RESULTS[a1b8cfbd3adc1faf21a613384c4cb8fdf05dee35]: utility_example
