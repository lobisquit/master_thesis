...
#+BEGIN_SRC plantuml :file ../figures/layers_diagram.png :noweb yes
  <<plantuml_skin>>
...
#+CAPTION: A tree access networks connect users to the mainframe, placed along the internet backbone.
