...
estimation of it based on available information.
...
#+RESULTS[1aeae82b46a3422b121cba576d8d6c20dc52a89c]:
...
downloaded, merged and cropped to remove anything outside the border of the
city. cite:OpenStreetMap
...
crossing as vertices. \\
This procedure was performed using a dedicated library that took care of all the
quirks of OpenStreetMap measures[fn:2]: polygons were considered joinable up to
a certain distance of tolerance and everything outside the main connected
component was pruned.

After that, all nodes close to each other less than 20m were merged: this
removed many useless details and lowered the number of variables in the upcoming
analysis.

Then each buildings was assigned residents, i.e. users of our access network,
...
9272 edges and its complexity can be handled in the following analysis. \\
...
| [[ac:ilp][ILP]] lower bound [M€] | 65.05 |             38.08 |
