...
All this information can be visualized in the map of [[autoref:fig:aachen_city_map]].
...
to be fast enough for our case, will prove to be good ones, close to the
theoretical optimum.
