...
[[autoref:solution_table]] clearly shows that the sub-optimal heuristic approach is
...
A visual representation of the obtained clusters in the two steps is given in
[[autoref:fig:heuristic_result]], where again the map is cropped in order to scale
