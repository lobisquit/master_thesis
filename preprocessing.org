...
** Interarrival distribution
   ...
   #+BEGIN_SRC bash :tangle scripts/5_distribution.sh :var pcap_files=pcap_files :results none
     ...
     do
         ...
         pv $csv_file \
             | gunzip -c \
             | cargo run --release --manifest-path=scripts/interarrival_binner/Cargo.toml $min $max 10 2> /dev/null \
   ...
   #+BEGIN_SRC python :tangle scripts/6_plotting.py :var pcap_files=pcap_files
     import numpy as np
