...
#+BEGIN_SRC python
  def get_terminal_distance(G, is_terminal, distance_path, clear_cache=False):
...
#+BEGIN_SRC python
  ...
  def heuristic_solve(G, params, cache_path):
      ...
      terminal_dist = get_terminal_distance(G, is_terminal, cache_path)
...
#+BEGIN_SRC python :noweb yes :var params=extract(DSLAM_params) :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/14_solver_heuristic_DSLAM.py
  ...
  # find optimal configuration
  cache_path = Path('data/aachen_net/distance_matrix_DSLAM_temp.h5')
  G_prime = heuristic_solve(G, dict(params), cache_path)
...
#+BEGIN_SRC python :noweb yes :var params=extract(2router_params) :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/18_solver_heuristic_2router.py
  ...
  # find optimal configuration
  cache_path = Path('data/aachen_net/distance_matrix_2router_temp.h5')
