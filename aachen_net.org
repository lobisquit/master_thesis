...
#+NAME: plot_result
#+BEGIN_SRC python
  def plot_result(G, projection=None, cut=True, title=None, ax=None, root_markersize=2):
...
#+BEGIN_SRC python :noweb yes :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/19_plot_heuristic_2router.py
  ...
  # plt.show()
  plt.savefig('figures/heuristic-2router.png', dpi=250)
  plt.close('all')
#+END_SRC

# ** TODO Mainframe positioning
# Each 2nd level router is estimated to cost roughly 15.000€, and lump cost for
# connecting it to the mainframe doubles its price.
# Distance $d_M$ is set to a very high value, since in this case it is not relevant.
...
# *** ILP
# #+BEGIN_SRC python :noweb yes :var params=extract(mainframe_params) :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/16_solver_ILP_mainframe.py
#   <<solver_ILP>>
#   <<convert_properties_nx>>
...
#   # find optimal configuration
#   G_prime = ILP_solve(G, dict(params), "logs/mainframe_ILP.log", 0.02)

#   # output to graphml file
#   convert_properties_nx(G_prime, str)
#   nx.write_graphml(G_prime, graph_path + "_mainframe_ILP.graphml")
#   logger.info("Graph saved to file")
# #+END_SRC

# Plot detail of obtained graph.

# #+BEGIN_SRC python :noweb yes :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/17_plot_ILP_mainframe.py
#   <<imports_&_defaults>>
#   <<projection>>
#   <<graph_utils>>
#   <<plot_result>>

#   G = load_graph(graph_path + "_mainframe_ILP.graphml")
#   convert_properties(G, float)
...
# #+BEGIN_SRC python :noweb yes :var params=extract(mainframe_params) :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/18_solver_heuristic_mainframe.py
#   <<imports_&_defaults>>
...
#   # output to graphml file
#   convert_properties(G_prime, str)
#   G_prime.save(graph_path + "_mainframe_heuristic.graphml")
# #+END_SRC

# Plot detail of obtained graph.

# #+BEGIN_SRC python :noweb yes :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/19_plot_heuristic_mainframe.py
#   <<imports_&_defaults>>
#   <<projection>>
#   <<graph_utils>>
#   <<plot_result>>
