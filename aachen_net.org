...
*** ILP
#+BEGIN_SRC python :noweb yes :var params=extract(2router_params) :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/15_solver_ILP_2router.py
  <<solver_ILP>>
...
#+BEGIN_SRC python :noweb yes :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/16_plot_ILP_2router.py
  <<imports_&_defaults>>
  <<projection>>
  <<graph_utils>>
  <<plot_result>>
...
#+BEGIN_SRC python :noweb yes :var params=extract(2router_params) :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/17_solver_heuristic_2router.py
  <<imports_&_defaults>>
...
#+BEGIN_SRC python :noweb yes :var graph_path=flatten(graph_path) :tangle scripts/aachen_net/18_plot_heuristic_2router.py
  <<imports_&_defaults>>
  <<projection>>
  <<graph_utils>>
  <<plot_result>>
